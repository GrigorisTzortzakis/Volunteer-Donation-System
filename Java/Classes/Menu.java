...
public class Menu {
            ...
            try {
                switch (choice) {
                    case "1":
                        ...
                        break;
                    case "2":
                        handleMonitorOrganization();
                        break;
                    case "3":
                        triggerLogout();  // Use the existing logout mechanism
                        return;
                    case "4":
                        System.out.println("Thank you for using our system. Goodbye!");
                        System.exit(0);
            ...
            try {
                switch (choice) {
                    case "1":
                        ...
                        return;
                    case "2":
                        showCommandLineBeneficiaryMenu(beneficiary);
                        break;
                    case "3":
                        triggerLogout();  // Set logout flag
                        return;
    ...
    private void showCommandLineBeneficiaryMenu(Beneficiary beneficiary) throws Exceptions.InvalidMenuException {
        while (true) {
            System.out.println("\nMenu Options:");
